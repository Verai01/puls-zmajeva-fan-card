...
const bs: Dict = {
  ...
  "landing.heroLead": "Unesi svoj puls, prognoziraj rezultat i budi dio najveće navijačke zajednice",
  "landing.heroLeadStrong": "na svijetu.",
  "landing.ctaCreate": "Kreiraj svoju BiH Puls Card",
  "landing.ctaViewCard": "Pogledaj svoju Puls Card",
  "landing.ctaViewResults": "Pogledaj rezultate",
  "landing.howItWorks": "Kako funkcioniše?",
  "landing.step1": "Prognoziraj sva 3 meča",
  "landing.step2": "Unesi svoj Puls Zmajeva",
  "landing.step3": "Preuzmi ili podijeli svoju BiH Puls Card",
  ...
  "status.tip": "Unesi prognozu",
  "status.submitted": "Prognoza poslana",
  "status.open": "Otvoreno za prognozu",
  "status.live": "U toku",
  "status.finished": "Završeno",
  "status.upcoming": "Uskoro",
  "status.predictionClosed": "Prognoza zatvorena",

  // match detail
  "match.alreadyPredicted": "Već si poslao prognozu za ovu utakmicu",
  "match.viewCard": "Pogledaj svoju BiH Puls Card",
  "match.opponentTbd": "Protivnik još nije potvrđen. Prognoze će biti otvorene uskoro.",
  "match.predict": "Unesi prognozu",
  ...
  "create.predictScore": "Prognoziraj rezultat",
  "create.predictingAs": "Prognoziraš kao",
  "create.yourPulse": "Kakav ti je puls?",
  "create.updatePulse": "Ažuriraj svoj puls",
  "create.enterNumber": "Unesi broj:",
  "create.savePrediction": "Spremi prognozu",
  "create.createCard": "Napravi Puls Card",
  "create.sending": "Šaljem…",
  "create.savedTitle": "Prognoza je spremljena",
  "create.savedDesc": "Tvoja prognoza je zabilježena. Pogledaj svoju Puls Card ili rezultate.",
  ...
  "start.title": "Prognoziraj sve utakmice",
  "start.subtitle": "Unesi prognozu za svaku otvorenu utakmicu. Sve dijele istu Puls Card.",
  "start.noOpenMatches": "Trenutno nema otvorenih utakmica za prognozu.",
  "start.submitAll": "Napravi Puls Card",
  "start.submitting": "Šaljem…",
  "start.selectHint": "Otključaj utakmicu da uneseš prognozu",
  ...
  "card.shareFallback": "Slika je sačuvana. Podijeli je na Instagram Story.",
  ...
  "lb.noTips": "Nema prognoza za ovu utakmicu.",
};
...
const en: Dict = {
  ...
  "landing.ctaViewCard": "Show your Puls Card",
  "landing.ctaViewResults": "View results",
  "landing.howItWorks": "How does it work?",
  "landing.step1": "Predict all 3 matches",
  "landing.step2": "Enter your Puls Zmajeva",
  "landing.step3": "Download or share your BiH Puls Card",
  ...
  "create.savedDesc": "Your prediction has been saved. View your Puls Card or the results.",
  ...
  "card.shareFallback": "Image saved. Share it on your Instagram Story.",
...
const de: Dict = {
  ...
  "landing.ctaViewCard": "Zeige deine Puls Card",
  "landing.ctaViewResults": "Ergebnisse ansehen",
  "landing.howItWorks": "Wie funktioniert es?",
  "landing.step1": "Tippe alle 3 Spiele",
  "landing.step2": "Gib deinen Puls Zmajeva ein",
  "landing.step3": "Lade deine BiH Puls Card herunter oder teile sie",
  ...
  "create.savedDesc": "Dein Tipp wurde gespeichert. Sieh dir deine Puls Card oder die Ergebnisse an.",
  ...
  "card.shareFallback": "Bild gespeichert. Teile es in deiner Instagram Story.",
